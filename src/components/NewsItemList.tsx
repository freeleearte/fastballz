...
const NewsItemData = [
    ...
    },
    {
        imgSrc: img3,
        imgAlt: '설명 3',
        title: '약속의 8회 NC, KIA에 짜릿한 역전 드라마',
        description: 'NC 다이노스가 24일 KIA 타이거즈를 상대로 8-4 역전승을 거두며 짜릿한 드라마를 연출했다. 류지혁과 김성윤의 활약, 이성규의 역전 득점, 밀어내기 볼넷과 2타점 2루타 등으로 8회 대거 5득점하며 승부를 뒤집었다. 선발 이승현은 4이닝 3실점, 승리는 이호성이 챙겼다.',
    },
    {
        imgSrc: img4,
        imgAlt: '설명 4',
